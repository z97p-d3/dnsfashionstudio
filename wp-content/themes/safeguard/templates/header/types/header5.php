		...
		<nav id="nav" class="navbar">
			<div class="container ">
				...
				<div class="nav-custom-info-wrap">
					<?php if ( !empty( safeguard_get_option('header_type5_block1_content', '') ) ) { ?>
						<div class="nav-custom-info">
								<div class="header_type5_block1_content"><?php if ( !empty( safeguard_get_option('header_type5_block1_icon', '' ) ) ) { ?>
								
			                 		<span class="<?php echo safeguard_get_option('header_type5_block1_icon', ''); ?>"></span>
			                 
							<?php } ?>
						<?php echo safeguard_get_option('header_type5_block1_content', ''); ?></div>
	                    </div>
					<?php } ?>
					<?php if ( !empty( safeguard_get_option('header_type5_block2_content', '') ) ) { ?>
						<div class="nav-custom-info">
	                    	 <div class="header_type5_block1_content"><?php if ( !empty( safeguard_get_option('header_type5_block2_icon', '' ) ) ) { ?>
								
			                 		<span class="<?php echo safeguard_get_option('header_type5_block2_icon', ''); ?>"></span>
			                 
	                    	<?php } ?>
                           <?php echo safeguard_get_option('header_type5_block2_content', ''); ?></div>
	                    </div>
					<?php } ?>
					<?php if ( !empty( safeguard_get_option('header_type5_block3_content', '') ) ) { ?>
						<div class="nav-custom-info">
	                    	<div class="header_type5_block1_content"><?php if ( !empty( safeguard_get_option('header_type5_block3_icon', '' ) ) ) { ?>
								
			                 		<span class="<?php echo safeguard_get_option('header_type5_block3_icon', ''); ?>"></span>
			                 	
	                    	<?php } ?>
                            <?php echo safeguard_get_option('header_type5_block3_content', ''); ?></div>
	                    </div>  
					<?php } ?> 
				</div>
			</div>
		...
		<div class="header-navibox-2">
			<div class="container">
				...
				<?php if ($safeguard_header['header_phone']) : ?>
					<?php if ( !empty( safeguard_get_option('header_type5_rblock_text', '') ) ) { ?>
						<ul class="phone-menu">
							<li class="no-hover header_type5_rblock_link">
								<?php if ( !empty( safeguard_get_option('header_type5_rblock_link', '') ) ) { ?>
									<a href="<?php echo safeguard_get_option('header_type5_rblock_link', ''); ?>">
										<?php echo safeguard_get_option('header_type5_rblock_text', ''); ?>
									</a>
								<?php } else { ?>
									<?php echo safeguard_get_option('header_type5_rblock_text', ''); ?>
								<?php } ?>		
